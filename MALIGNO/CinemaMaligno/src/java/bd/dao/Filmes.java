...
public class Filmes {
    public static boolean cadastrado (int codigo) throws Exception
    {
        ...
        try
        {
            ...
            BDSQLServer.COMANDO.prepareStatement (sql); // prepara o comando a partir d euma string

            BDSQLServer.COMANDO.setInt (1, codigo); // interrogações são em ordem

            MeuResultSet resultado = (MeuResultSet)BDSQLServer.COMANDO.executeQuery (); // executa o comando
    ...
    public static void incluir (Filme filme) throws Exception
    {
        ...
        try
        {
            ...
            BDSQLServer.COMANDO.executeUpdate (); // altera o banco
            BDSQLServer.COMANDO.commit        (); // comitas ela
        }
        catch (SQLException erro)
        {
    ...
    public static Filme getFilme (int codigo) throws Exception
    {
        ...
        try
        {
            ...
            if (!resultado.first()) // n retornar nada
                throw new Exception ("Nao cadastrado");
